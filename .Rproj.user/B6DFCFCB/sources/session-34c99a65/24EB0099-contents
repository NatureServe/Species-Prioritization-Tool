                   ...
                   fluidRow(
                     ...
                     column(width = 3,
                            div(style = "width: 90%; padding: 1em; background-color: rgba(211, 211, 211, 0.8);",
                                ...
                                fluidRow(style = "padding-left: 15px;", actionButton("open_guide", label = "Open Users Guide", onclick ="window.open('https://natureserve01.sharepoint.com/:w:/g/teamsites/BLM/Ef5rCPh-XA1JjVPrdT9x8boBx0heRpsdhdvDKODd9BTJww?e=ypOcxO', '_blank')", width = "95%")),
